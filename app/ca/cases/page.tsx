...
type Intake = { customerName: string; customerEmail: string; customerPhone: string; serviceName: string; taxCase: TaxCase; documents: { originalFilename: string; verificationStatus: string }[]; missingDocuments: { name: string }[] };
